...
const ShowCateBlog = () => {
    ...
    const deleteCate = (id) => {
        axios
            .delete("http://127.0.0.1:8000/api/cate-blog/delete/" + id)
            .then(function (response) {
                setList();
            })
            .catch(function (error) {
    ...
    const deleteCateAll = (id) => {
        axios
            .delete("http://127.0.0.1:8000/api/cate-blog/delete")
            .then(function (response) {
                setList();
            })
            .catch(function (error) {
            ...
            <div className="col-12">
                <div className="d-flex justify-content-end my-3">
                    <button type="button" className="btn btn-light">
                        <Link to="/admin/add-cate-blog" className="btn btn-primary">
                            Add cate
            </Link>
                    </button>
                    <button type="button" className="btn btn-light">
                            ...
                            <tbody>
                                {items.map((cate, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <Link to={`edit-cate-blog/${cate.id}`}>
